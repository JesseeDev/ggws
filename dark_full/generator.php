			...
			<div class="content-page">
					...
					<div class="container">
						...
						<div class="row">
							<div class="col-sm-12">
								...
								<h4 class="page-title">Generator</h4>
                                <p class="text-muted page-title-alt">Enjoy thanks for choosing Universal Generator!</p>
                            </div>
                        </div>
						...
						<div class="row">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="widget-bg-color-icon card-box">
								  ...
								  ?></b></h3>
                                        <p class="text-muted">Today's Generates</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
              ...
              <div class="row">
					...
					while ($row = mysqli_fetch_array($result)) {
						echo '
	<div class="col-sm-3" id="center" >
		<div class="panel panel-default">
								<div class="panel-heading dark-overlay">'.$row['name'].' Generator   &nbsp;<a  href="'.$row['link'].'"  target="_blank"><i class="fa fa-external-link pull-right" aria-hidden="true"></i></a> </div>
								<div class="panel-body">
									<center><img class="faa-tada animated-hover" src="pic/'.$row["name"].'.png" alt="'.$row["name"].'" width="150" height="150"></center></br>
